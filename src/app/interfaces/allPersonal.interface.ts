// To parse this data:
//
//   import { Convert, AllPersonal } from "./file";
//
//   const allPersonal = Convert.toAllPersonal(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface AllPersonal {
    success: boolean;
    message: string;
    code:    string;
    content: Content[];
...
export class Convert {
    public static toAllPersonal(json: string): AllPersonal {
        return cast(JSON.parse(json), r("AllPersonal"));
    }

    public static allPersonalToJson(value: AllPersonal): string {
        return JSON.stringify(uncast(value, r("AllPersonal")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Content": o([
        ...
        { json: "destinoHabitual", js: "destinoHabitual", typ: u(null, "") },
